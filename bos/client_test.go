...
func TestGetURL(t *testing.T) {
	expected := "http://bucket-0.bj.bcebos.com/object-0"
	...
	expected = "http://bj.bcebos.com/object-0"
			...
			if err != nil {
				...
				if err != nil {
					...
					if err != nil {
						...
						if err != nil {
							t.Error(util.FormatTest(method, err.Error(), "nil"))
						} else if length != contentLength*3 {
							t.Error(util.FormatTest(method, strconv.Itoa(length), strconv.Itoa(contentLength*3)))
						}
					}
				}
			}
